...
screen_width1 = 800
screen_hight = 600
screen_size = screen_width1, screen_hight
...
class Menu():
    def __init__(self):
        ...
        self.score_rect.center = screen_size[0] / 2, self.play_rect.center[
            1] + self.score_img.get_height() + self.score_img.get_height() / 2

        self.instruction_img = instruction_img
        self.instruction_rect = self.instruction_img.get_rect()
        self.instruction_rect.center = screen_size[0] / 2, self.score_rect.center[
            1] + self.score_img.get_height() + self.score_img.get_height() / 2

        self.exit_img = exit_img
        self.exit_rect = self.exit_img.get_rect()
        self.exit_rect.center = screen_size[0] / 2, self.instruction_rect.center[
            1] + self.score_img.get_height() + self.score_img.get_height() / 2
